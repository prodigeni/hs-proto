...
# source: bnet/protocol/config.proto
...
RPCMethodConfig = _reflection.GeneratedProtocolMessageType('RPCMethodConfig', (_message.Message,), dict(
  ...
  __module__ = 'bnet.protocol.config_pb2'
