...
# source: bnet/protocol/connection.proto
...
_CONNECTIONMETERINGCONTENTHANDLES.fields_by_name['content_handle'].message_type = bnet_dot_protocol__0__pb2._CONTENTHANDLE
_CONNECTREQUEST.fields_by_name['client_id'].message_type = bnet_dot_protocol__0__pb2._PROCESSID
_CONNECTREQUEST.fields_by_name['bind_request'].message_type = _BINDREQUEST
_CONNECTRESPONSE.fields_by_name['server_id'].message_type = bnet_dot_protocol__0__pb2._PROCESSID
_CONNECTRESPONSE.fields_by_name['client_id'].message_type = bnet_dot_protocol__0__pb2._PROCESSID
...
BindResponse = _reflection.GeneratedProtocolMessageType('BindResponse', (_message.Message,), dict(
  DESCRIPTOR = _BINDRESPONSE,
  __module__ = 'bnet.protocol.connection_pb2'
  # @@protoc_insertion_point(class_scope:bnet.protocol.connection.BindResponse)
  ))
_sym_db.RegisterMessage(BindResponse)

BoundService = _reflection.GeneratedProtocolMessageType('BoundService', (_message.Message,), dict(
...
BindRequest = _reflection.GeneratedProtocolMessageType('BindRequest', (_message.Message,), dict(
...
DisconnectNotification = _reflection.GeneratedProtocolMessageType('DisconnectNotification', (_message.Message,), dict(
...
ConnectionMeteringContentHandles = _reflection.GeneratedProtocolMessageType('ConnectionMeteringContentHandles', (_message.Message,), dict(
