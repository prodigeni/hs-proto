...
// source: bnet/protocol/authentication.proto
// DO NOT EDIT!
...
It is generated from these files:
	bnet/protocol/authentication.proto
...
import math "math"
import bnet_protocol_account "bnet/protocol"
...
type LogonQueueUpdateRequest struct {
	...
	EstimatedTime     *uint64 `protobuf:"varint,2,opt,name=estimated_time" json:"estimated_time,omitempty"`
	EtaDeviationInSec *uint64 `protobuf:"varint,3,opt,name=eta_deviation_in_sec" json:"eta_deviation_in_sec,omitempty"`
	XXX_unrecognized  []byte  `json:"-"`
}
...
type LogonRequest struct {
	...
	DisconnectOnCookieFail       *bool   `protobuf:"varint,9,opt,name=disconnect_on_cookie_fail" json:"disconnect_on_cookie_fail,omitempty"`
	AllowLogonQueueNotifications *bool   `protobuf:"varint,10,opt,name=allow_logon_queue_notifications" json:"allow_logon_queue_notifications,omitempty"`
	WebClientVerification        *bool   `protobuf:"varint,11,opt,name=web_client_verification" json:"web_client_verification,omitempty"`
...
type ModuleMessageRequest struct {
	ModuleId         *int32 `protobuf:"varint,1,opt,name=module_id" json:"module_id,omitempty"`
...
type ServerStateChangeRequest struct {
	...
	EventTime        *uint64 `protobuf:"varint,2,opt,name=event_time" json:"event_time,omitempty"`
	XXX_unrecognized []byte  `json:"-"`
}
...
type ModuleLoadRequest struct {
	ModuleHandle     *bnet_protocol.ContentHandle `protobuf:"bytes,1,opt,name=module_handle" json:"module_handle,omitempty"`
	Message          []byte                       `protobuf:"bytes,2,opt,name=message" json:"message,omitempty"`
	XXX_unrecognized []byte                       `json:"-"`
}
...
type GameAccountSelectedRequest struct {
	...
	GameAccount      *bnet_protocol.EntityId `protobuf:"bytes,2,opt,name=game_account" json:"game_account,omitempty"`
	XXX_unrecognized []byte                  `json:"-"`
}
...
type LogonResult struct {
	...
	GameAccount      []*bnet_protocol.EntityId `protobuf:"bytes,3,rep,name=game_account" json:"game_account,omitempty"`
	Email            *string                   `protobuf:"bytes,4,opt,name=email" json:"email,omitempty"`
...
type SelectGameAccountRequest struct {
	GameAccount      *bnet_protocol.EntityId `protobuf:"bytes,1,opt,name=game_account" json:"game_account,omitempty"`
	XXX_unrecognized []byte                  `json:"-"`
}
