...
// source: bnet/protocol/attribute.proto
// DO NOT EDIT!
...
type Variant struct {
	...
	EntityidValue    *bnet_protocol.EntityId `protobuf:"bytes,10,opt,name=entityid_value" json:"entityid_value,omitempty"`
...
func (m *Variant) GetEntityidValue() *bnet_protocol.EntityId {
	if m != nil {
...
type AttributeFilter struct {
	Op               *AttributeFilter_Operation `protobuf:"varint,1,opt,name=op,enum=bnet.protocol.attribute.AttributeFilter_Operation" json:"op,omitempty"`
