...
import math "math"
import bnet_protocol_account1 "bnet/protocol"
...
type AccountLevelInfo struct {
	Licenses         []*bnet_protocol_account1.AccountLicense `protobuf:"bytes,3,rep,name=licenses" json:"licenses,omitempty"`
...
func (m *AccountLevelInfo) GetLicenses() []*bnet_protocol_account1.AccountLicense {
	if m != nil {
		return m.Licenses
	}
	return nil
...
type CreateGameAccountRequest struct {
	Account          *bnet_protocol_account1.AccountId `protobuf:"bytes,1,opt,name=account" json:"account,omitempty"`
...
func (m *CreateGameAccountRequest) GetAccount() *bnet_protocol_account1.AccountId {
	if m != nil {
		return m.Account
	}
	return nil
...
type CredentialUpdateRequest struct {
	Account          *bnet_protocol_account1.AccountId           `protobuf:"bytes,1,opt,name=account" json:"account,omitempty"`
	OldCredentials   []*bnet_protocol_account1.AccountCredential `protobuf:"bytes,2,rep,name=old_credentials" json:"old_credentials,omitempty"`
	NewCredentials   []*bnet_protocol_account1.AccountCredential `protobuf:"bytes,3,rep,name=new_credentials" json:"new_credentials,omitempty"`
...
func (m *CredentialUpdateRequest) GetAccount() *bnet_protocol_account1.AccountId {
	if m != nil {
		return m.Account
	}
	return nil
...
func (m *CredentialUpdateRequest) GetOldCredentials() []*bnet_protocol_account1.AccountCredential {
	if m != nil {
...
func (m *CredentialUpdateRequest) GetNewCredentials() []*bnet_protocol_account1.AccountCredential {
	if m != nil {
...
type CurrencyRestriction struct {
	...
	AuthenticatorCap *string `protobuf:"bytes,2,opt,name=authenticator_cap" json:"authenticator_cap,omitempty"`
	SoftCap          *string `protobuf:"bytes,3,opt,name=soft_cap" json:"soft_cap,omitempty"`
	XXX_unrecognized []byte  `json:"-"`
}
...
func (m *FlagUpdateRequest) GetAccount() *bnet_protocol_account1.AccountId {
	if m != nil {
		return m.Account
	}
	return nil
...
type CacheExpireRequest struct {
	Account          []*bnet_protocol_account1.AccountId `protobuf:"bytes,1,rep,name=account" json:"account,omitempty"`
...
func (m *CacheExpireRequest) GetAccount() []*bnet_protocol_account1.AccountId {
	if m != nil {
		return m.Account
	}
	return nil
...
type GameAccountBlob struct {
	...
	RealmPermissions       *uint32                                  `protobuf:"varint,3,opt,name=realm_permissions" json:"realm_permissions,omitempty"`
	...
	BillingFlags           *uint32                                  `protobuf:"varint,6,opt,name=billing_flags" json:"billing_flags,omitempty"`
	CacheExpiration        *uint64                                  `protobuf:"varint,7,opt,name=cache_expiration" json:"cache_expiration,omitempty"`
	...
	Licenses               []*bnet_protocol_account1.AccountLicense `protobuf:"bytes,20,rep,name=licenses" json:"licenses,omitempty"`
	XXX_unrecognized       []byte                                   `json:"-"`
}
...
func (m *GameAccountBlob) GetLicenses() []*bnet_protocol_account1.AccountLicense {
	if m != nil {
		return m.Licenses
	}
	return nil
...
type GameLevelInfo struct {
	...
	Licenses         []*bnet_protocol_account1.AccountLicense `protobuf:"bytes,10,rep,name=licenses" json:"licenses,omitempty"`
...
func (m *GameLevelInfo) GetLicenses() []*bnet_protocol_account1.AccountLicense {
	if m != nil {
		return m.Licenses
	}
	return nil
...
type GetAccountRequest struct {
	...
	FetchAll              *bool             `protobuf:"varint,10,opt,name=fetch_all" json:"fetch_all,omitempty"`
	FetchBlob             *bool             `protobuf:"varint,11,opt,name=fetch_blob" json:"fetch_blob,omitempty"`
	FetchId               *bool             `protobuf:"varint,12,opt,name=fetch_id" json:"fetch_id,omitempty"`
	FetchEmail            *bool             `protobuf:"varint,13,opt,name=fetch_email" json:"fetch_email,omitempty"`
	FetchBattleTag        *bool             `protobuf:"varint,14,opt,name=fetch_battle_tag" json:"fetch_battle_tag,omitempty"`
	FetchFullName         *bool             `protobuf:"varint,15,opt,name=fetch_full_name" json:"fetch_full_name,omitempty"`
	FetchLinks            *bool             `protobuf:"varint,16,opt,name=fetch_links" json:"fetch_links,omitempty"`
	FetchParentalControls *bool             `protobuf:"varint,17,opt,name=fetch_parental_controls" json:"fetch_parental_controls,omitempty"`
	XXX_unrecognized      []byte            `json:"-"`
}
...
type GetEBalanceRequest struct {
	AccountId          *bnet_protocol_account1.AccountId `protobuf:"bytes,1,opt,name=account_id" json:"account_id,omitempty"`
...
func (m *GetEBalanceRequest) GetAccountId() *bnet_protocol_account1.AccountId {
	if m != nil {
		return m.AccountId
	}
	return nil
...
type GetLicensesResponse struct {
	Licenses         []*bnet_protocol_account1.AccountLicense `protobuf:"bytes,1,rep,name=licenses" json:"licenses,omitempty"`
	XXX_unrecognized []byte                                   `json:"-"`
}
...
func (m *GetLicensesResponse) GetLicenses() []*bnet_protocol_account1.AccountLicense {
	if m != nil {
		return m.Licenses
	}
	return nil
...
func (m *GetWalletListRequest) GetAccountId() *bnet_protocol_account1.AccountId {
	if m != nil {
		return m.AccountId
	}
	return nil
...
type AccountBlob struct {
	...
	FullName            *string                                     `protobuf:"bytes,10,opt,name=full_name" json:"full_name,omitempty"`
	Licenses            []*bnet_protocol_account1.AccountLicense    `protobuf:"bytes,20,rep,name=licenses" json:"licenses,omitempty"`
	Credentials         []*bnet_protocol_account1.AccountCredential `protobuf:"bytes,21,rep,name=credentials" json:"credentials,omitempty"`
	...
	CacheExpiration     *uint64                                     `protobuf:"varint,30,opt,name=cache_expiration" json:"cache_expiration,omitempty"`
...
func (m *AccountBlob) GetLicenses() []*bnet_protocol_account1.AccountLicense {
	if m != nil {
		return m.Licenses
	}
	return nil
...
func (m *AccountBlob) GetCredentials() []*bnet_protocol_account1.AccountCredential {
	if m != nil {
...
type GetAccountResponse struct {
	...
	Id                  *bnet_protocol_account1.AccountId `protobuf:"bytes,12,opt,name=id" json:"id,omitempty"`
...
func (m *GetAccountResponse) GetId() *bnet_protocol_account1.AccountId {
	if m != nil {
		return m.Id
	}
	return nil
...
type Wallet struct {
	...
	WalletId         *uint64 `protobuf:"varint,2,opt,name=wallet_id" json:"wallet_id,omitempty"`
	WalletType       *uint32 `protobuf:"varint,3,opt,name=wallet_type" json:"wallet_type,omitempty"`
	Description      *string `protobuf:"bytes,4,opt,name=description" json:"description,omitempty"`
	CountryId        *uint32 `protobuf:"varint,5,opt,name=country_id" json:"country_id,omitempty"`
...
type GetAccountStateRequest struct {
	...
	Region           *uint32                                     `protobuf:"varint,3,opt,name=region" json:"region,omitempty"`
	Options          *bnet_protocol_account1.AccountFieldOptions `protobuf:"bytes,10,opt,name=options" json:"options,omitempty"`
...
func (m *GetAccountStateRequest) GetOptions() *bnet_protocol_account1.AccountFieldOptions {
	if m != nil {
		return m.Options
	}
	return nil
...
type GetLicensesRequest struct {
	...
	ExcludeUnknownProgram     *bool                   `protobuf:"varint,6,opt,name=exclude_unknown_program" json:"exclude_unknown_program,omitempty"`
	XXX_unrecognized          []byte                  `json:"-"`
}
...
type SubscriberReference struct {
	...
	AccountOptions     *bnet_protocol_account1.AccountFieldOptions `protobuf:"bytes,3,opt,name=account_options" json:"account_options,omitempty"`
...
func (m *SubscriberReference) GetAccountOptions() *bnet_protocol_account1.AccountFieldOptions {
	if m != nil {
