...
It is generated from these files:
	bnet/protocol/connection.proto
...
type EchoRequest struct {
	...
	NetworkOnly      *bool   `protobuf:"varint,2,opt,name=network_only" json:"network_only,omitempty"`
...
type ConnectResponse struct {
	ServerId           *bnet_protocol.ProcessId          `protobuf:"bytes,1,opt,name=server_id" json:"server_id,omitempty"`
