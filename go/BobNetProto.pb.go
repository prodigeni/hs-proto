...
type PACKET_TYPES_BobNetCount int32

const (
	PACKET_TYPES_COUNT PACKET_TYPES_BobNetCount = 500
)

var PACKET_TYPES_BobNetCount_name = map[int32]string{
	500: "COUNT",
}
var PACKET_TYPES_BobNetCount_value = map[string]int32{
	"COUNT": 500,
}

func (x PACKET_TYPES_BobNetCount) Enum() *PACKET_TYPES_BobNetCount {
	p := new(PACKET_TYPES_BobNetCount)
	*p = x
	return p
}
func (x PACKET_TYPES_BobNetCount) String() string {
	return proto.EnumName(PACKET_TYPES_BobNetCount_name, int32(x))
}
func (x *PACKET_TYPES_BobNetCount) UnmarshalJSON(data []byte) error {
	value, err := proto.UnmarshalJSONEnum(PACKET_TYPES_BobNetCount_value, data, "PACKET_TYPES_BobNetCount")
	if err != nil {
		return err
	}
	*x = PACKET_TYPES_BobNetCount(value)
	return nil
}
...
type AutoLogin struct {
	...
	BuildId          *int32  `protobuf:"varint,3,opt,name=build_id" json:"build_id,omitempty"`
	DebugName        *string `protobuf:"bytes,4,opt,name=debug_name" json:"debug_name,omitempty"`
...
type DebugConsoleResponse struct {
	...
	ResponseType     *DebugConsoleResponse_ResponseType `protobuf:"varint,2,opt,name=response_type,enum=BobNetProto.DebugConsoleResponse_ResponseType" json:"response_type,omitempty"`
	XXX_unrecognized []byte                             `json:"-"`
}
...
type PACKET_TYPES struct {
	XXX_unrecognized []byte `json:"-"`
}

func (m *PACKET_TYPES) Reset()         { *m = PACKET_TYPES{} }
func (m *PACKET_TYPES) String() string { return proto.CompactTextString(m) }
func (*PACKET_TYPES) ProtoMessage()    {}
...
func (m *AuroraHandshake) GetPlatform() *PegasusShared.Platform {
	if m != nil {
		return m.Platform
	}
	return nil
...
func init() {
	proto.RegisterEnum("BobNetProto.AutoLogin_PacketID", AutoLogin_PacketID_name, AutoLogin_PacketID_value)
	...
	proto.RegisterEnum("BobNetProto.PACKET_TYPES_BobNetCount", PACKET_TYPES_BobNetCount_name, PACKET_TYPES_BobNetCount_value)
	proto.RegisterEnum("BobNetProto.Ping_PacketID", Ping_PacketID_name, Ping_PacketID_value)
	proto.RegisterEnum("BobNetProto.Pong_PacketID", Pong_PacketID_name, Pong_PacketID_value)
	proto.RegisterEnum("BobNetProto.AuroraHandshake_PacketID", AuroraHandshake_PacketID_name, AuroraHandshake_PacketID_value)
}
